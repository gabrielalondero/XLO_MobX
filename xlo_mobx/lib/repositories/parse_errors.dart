class ParseErrors {
  //todos os códigos de rro que podem ser recebidos do parse
  static final Map<int, Object> _error = {
    -1: 'Erro desconhecido',
...
//se pedir getDescription passando o código de erro, acessa o mapa e retorna
  static Object? getDescription(int error) {
    return _error[error];
  }
}
